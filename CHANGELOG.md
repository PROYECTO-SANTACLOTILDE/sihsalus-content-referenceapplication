...
- Agrega `Get Concepts` al rol `Admision` para cargar los conjuntos codificados de ocupación, idioma, religión,
  grado de instrucción y etnia durante el registro de pacientes, y valida que conserve `Get Patient Identifiers`;
  ninguno de estos permisos otorga acceso de gestión.
