...
- Estandariza scripts de CI en Python reutilizable para validacion de rangos de referencia y clasificacion de logs SIHSALUS, manteniendo wrappers shell por compatibilidad.
