...
El workspace de resumen de consulta también exige su privilegio de edición, por
lo que conocer el nombre del workspace o tener acceso de lectura no habilita el
guardado.
