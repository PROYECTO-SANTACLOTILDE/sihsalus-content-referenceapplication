...
EXPECTED_CE001 = {
    ...
    "activeVersion": "1.0.2",
    "previousPersistedFormUuid": "da631d8c-c695-3c4a-9d77-19bbbf0174e3",
    "activePersistedFormUuid": "df1a34b4-0e8f-3564-84d9-55ce9e4284bd",
}
CHANGE_SET_IDS = {
...
def validate_contract_shape(contract):
    ...
    if contract.get("ce001") != EXPECTED_CE001:
        errors.append(f"{CONTRACT_PATH}: CE-001 historical identity contract changed")
...
def validate(root, frontend_root=None):
    ...
    ce001 = read_json(root / CE001_PATH, errors)
    if ce001.get("name") != contract["ce001"]["name"] or ce001.get("version") != contract["ce001"]["activeVersion"]:
        errors.append(f"{root / CE001_PATH}: name/version do not match the Visit Note contract")
    try:
