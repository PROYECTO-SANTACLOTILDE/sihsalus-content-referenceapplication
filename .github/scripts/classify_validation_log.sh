...
csv_pattern='(An OpenMRS object could not be constructed or saved from the following CSV line|BEGINNING OF CSV FILE ERROR SUMMARY|was processed and [0-9]+ out of [0-9]+ entities were not saved|No encounter was found for this form|ERROR - BaseCsvLoader)'
